...
from core_copy.chat_history_manager_copy import ChatHistoryManager
from core_copy.facts_manager_copy import FactManager
from core_copy.summary_manager_copy import SummaryManager
...
class Memory:
    ...
    def prepare_memory_for_llm(self) -> List[BaseMessage]:
        ...
        if unsummarized_count > 0:
            ...
            print("最近未摘要的消息：", recent_messages)
        return result
